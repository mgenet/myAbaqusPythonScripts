...
pressure = step.historyRegions[step.historyRegions.keys()[num_history_region]].historyOutputs['PCAV'].data[-1][1]

open(odb_basename + '.fluid_cavity_final_pressure.dat', 'w').write(str(pressure))
